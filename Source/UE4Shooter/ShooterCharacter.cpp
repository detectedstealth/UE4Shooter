...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	if (bAiming)
	{
		// Shrink crosshairs a small amcount very quickly
...
void AShooterCharacter::DropWeapon()
{
	if (EquippedWeapon)
	{
		...
		EquippedWeapon->SetItemState(EItemState::EIS_Failling);
		EquippedWeapon->ThrowWeapon();
	}
}

void AShooterCharacter::SeleteButtonPressed()
{
	if (TraceHitItem)
	{
...
void AShooterCharacter::InterpCapsuleHalfHeight(float DeltaTime)
{
	...
	{
		TargetCapsuleHalfHeight = StandingCapsuleHalfHight;
	}
...
{
	// Check to see if AmmoMap contains the AmmoType
	if (AmmoMap.Find(Ammo->GetAmmoType()))
	{
		// Update the amount of ammo available
...
void AShooterCharacter::IncrementIntperLocItemCount(int32 Index, int32 Amount)
{
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	// Check OverlappedItemCount, than trace for items.
	TraceForItems();
...
void AShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Select", IE_Pressed, this, &AShooterCharacter::SeleteButtonPressed);
